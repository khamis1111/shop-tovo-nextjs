        ...
        <Card className="w-full max-w-3xl mx-auto">
            <CardContent className="p-6">
                <div className="space-y-4">
                    <div
                        className="border-2 border-dashed rounded-lg p-9 text-center cursor-pointer transition-colors duration-300 ease-in-out"
                    ...
                    >
                        ...
                        <p className="text-sm text-muted-foreground">
                            Drag and drop images here, or click to select them.
                        </p>
                    </div>
                    <input
                        type="file"
                    ...
                    {images.length > 0 && (
                        <div className="text-sm text-muted-foreground mb-2">
                            {images.length} {images.length !== 1 ? 'Images' : 'image'} Select
                        </div>
                    )}
